...
public class MemoController {
        ...
        @PostMapping("/api/post") // index파일 writePost에서 Post 방식 url "/api/memos" 부분을 받는 서버부분을 개발
        ...
        @GetMapping("api/posts") //index파일 getMessages()에서 "GET"방식 "/api/memos"을 가져온 것임.
        ...
        @PutMapping("/api/post/{id}") //index파일 submitEdit()에서 "PUT"방식 "/api/memos"을 가져온 것임.{id}추가 입력
