...
import lombok.Getter; //Getter : 본 필드의 값을 숨긴 채 내부에서 가공된 값을 꺼낼 수 있다.
import lombok.NoArgsConstructor; //제일 기본인 생성자 어노테이션이다. 아무 인수가 없는 생성자를 생성해준다.
import javax.persistence.*; //개념 질문하기 (영속성이란? 지속성?)
